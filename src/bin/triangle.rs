...
fn main() {
    ...
    // Draw a triangle using BP and XF.
    // TODO: figure out what most of it means.
    // TODO: design a better API maybe.
    {
        let mut bp = gx.bp();
        bp.do_stuff();
    }
    {
        let mut xf = gx.xf();
        xf.set_viewport(0., 0., width as f32, height as f32, 1., 0.);
    }
    gx.invalidate_vertex_cache();
    {
        let mut bp = gx.bp();
        bp.do_stuff2();
    }
